...
train_dir= '/corpus/trainRND.txt'  # location of txt file containing train strings
valid_dir= '/corpus/validRND.txt'  # location of txt file containing validate strings
vocab_dir = '/corpus/vocab.txt'  # base name shared by data files
data_name= '10x10RND2'
result_filename= 'Val_resultsRND2'
...
checkpoint =  None #"checkpoint_A_10x10RND2.pth.tar" # path to checkpoint, None if none
